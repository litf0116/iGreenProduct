...
export function CreateTicket({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onSubmit({
      ...
      priority,
      dueDate,
      relatedTicketIds: isProblemTicket ? relatedTicketIds : undefined,
                ...
                {relatedTicketIds.length > 0 && (
                  <div className="flex flex-wrap gap-2 mt-2">
                    {relatedTicketIds.map(id => {
                      ...
                      return (
                        <div key={id} className="flex items-center gap-1 bg-background border px-2 py-1 rounded text-sm">
