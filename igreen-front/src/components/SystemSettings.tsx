                                            ...
                                            <TableRow key={type.id}>
                                                ...
                                                <TableCell className="text-right">
                                                    <div className="flex justify-end gap-2">
                                                        ...
                                                        <Button variant="ghost" size="sm" onClick={() => handleDeleteProblemClick(type.id)}
                                            ...
                                            <TableRow key={level.id}>
                                                ...
                                                <TableCell className="text-right">
                                                    <div className="flex justify-end gap-2">
                                                        ...
                                                        <Button variant="ghost" size="sm" onClick={() => handleDeleteLevelClick(level.id)}
                                                                className="text-destructive hover:text-destructive">
                                                            <Trash2 className="h-4 w-4"/>
                                                        </Button>
                                                    </div>
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            the {deleteType === "problem" ? "problem type" : "site level"} and remove it from the system.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
