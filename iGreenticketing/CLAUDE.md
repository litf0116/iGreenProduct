...
**Frontend (iGreenticketing/)**: React 18.3.1 + TypeScript + Vite admin dashboard (port 3000)
**Backend (backend-spring/)**: Spring Boot 3.2.0 + Java 21 REST API (port 8001)

```
/Users/mac/workspace/iGreenProduct/iGreenticketing/     # Frontend
/Users/mac/workspace/iGreenProduct/backend-spring/       # Backend
```

## Build & Test Commands

### Frontend (iGreenticketing)
```bash
...
### Monorepo Layout
```
iGreenticketing/              # React Frontend (Admin System)
├── src/
│   ├── components/
...
- `/Users/mac/workspace/iGreenProduct/iGreenticketing/tsconfig.json` - TypeScript strict mode config
...
### Key Source Files
- `/Users/mac/workspace/iGreenProduct/iGreenticketing/src/lib/api.ts` - Central API client (600+ lines)
- `/Users/mac/workspace/iGreenProduct/iGreenticketing/src/lib/types.ts` - Type definitions
- `/Users/mac/workspace/iGreenProduct/iGreenticketing/src/App.tsx` - Main app component
...
6. Add TypeScript types in `iGreenticketing/src/lib/types.ts`
7. Add API methods in `iGreenticketing/src/lib/api.ts`

### Adding New Frontend Component
1. Create component in `iGreenticketing/src/components/`
